...
const PATHS: Record<string, string> = {
  ...
  abstract: 'M5 1.5h6A1.5 1.5 0 0 1 12.5 3v10A1.5 1.5 0 0 1 11 14.5H5A1.5 1.5 0 0 1 3.5 13V3A1.5 1.5 0 0 1 5 1.5Zm.5 3v1.2h5V4.5h-5Zm0 3v1.2h5V7.5h-5Zm0 3v1.2h3v-1.2h-3Z',
  ...
  success: 'M8 1.5a6.5 6.5 0 1 0 0 13 6.5 6.5 0 0 0 0-13Zm3.3 4.8-4 4.4a.75.75 0 0 1-1.1 0L4.7 9.2l1.1-1 1 1.1 3.4-3.8 1.1 1Z',
  question: 'M8 1.5a6.5 6.5 0 1 0 0 13 6.5 6.5 0 0 0 0-13Zm.7 10.3h-1.4v-1.4h1.4v1.4Zm1.1-4.2-.6.7c-.4.4-.6.8-.6 1.4h-1.3c0-.9.3-1.4.8-1.9l.9-.9c.2-.2.3-.5.3-.8 0-.6-.5-1-1.2-1s-1.2.4-1.2 1.1H5.5c0-1.4 1.1-2.3 2.6-2.3 1.4 0 2.5.8 2.5 2 0 .6-.3 1.1-.8 1.7Z',
  important: 'M8 1.2 9.9 5.5l4.6.4-3.5 3.1 1 4.6L8 11.2l-4 2.4 1-4.6L1.5 5.9l4.6-.4L8 1.2Z',
  warning: 'M8.9 2.1a1 1 0 0 0-1.8 0l-5.5 10a1 1 0 0 0 .9 1.5h11a1 1 0 0 0 .9-1.5l-5.5-10ZM8.7 11.6H7.3v-1.4h1.4v1.4Zm0-2.6H7.3V5.6h1.4V9Z',
  caution: 'M8.9 2.1a1 1 0 0 0-1.8 0l-5.5 10a1 1 0 0 0 .9 1.5h11a1 1 0 0 0 .9-1.5l-5.5-10ZM8.7 11.6H7.3v-1.4h1.4v1.4Zm0-2.6H7.3V5.6h1.4V9Z',
  failure: 'M8 1.5a6.5 6.5 0 1 0 0 13 6.5 6.5 0 0 0 0-13Zm2.6 8.1-1 1L8 9l-1.6 1.6-1-1L7 8 5.4 6.4l1-1L8 7l1.6-1.6 1 1L9 8l1.6 1.6Z',
  ...
  quote: 'M6 4.2c-1.7 0-3 1.3-3 3 0 1.6 1.2 2.9 2.8 2.9.2 0 .4 0 .6-.1-.4 1-1.3 1.8-2.4 2.1l.4 1.2c2.3-.6 3.9-2.7 3.9-5.3 0-2.2-1.1-3.8-2.3-3.8Zm6 0c-1.7 0-3 1.3-3 3 0 1.6 1.2 2.9 2.8 2.9.2 0 .4 0 .6-.1-.4 1-1.3 1.8-2.4 2.1l.4 1.2c2.3-.6 3.9-2.7 3.9-5.3 0-2.2-1.1-3.8-2.3-3.8Z',
}
